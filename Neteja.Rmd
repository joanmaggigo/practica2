...
for(cols in llistat_estrelles)
{
  ...
  print(shapiro.test(sample(aux$notapersona,min(nrow(aux),5000))))
  print(fligner.test(notapersona ~ Season, data = aux))
  print(wilcox.test(notapersona ~ Season, data = aux, subset = Season %in% c("PRIMER TRIMESTRE", "TERCER TRIMESTRE")))
